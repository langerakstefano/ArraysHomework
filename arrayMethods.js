...
// const YearInventors = inventors.filter((inventor) => {
...
// Verwachte uitkomst: { first: 'Thomas', last: 'Edison', year: 1847, passed: 1931 }
 ...
 const EdiInventor = inventors.find ( (inventor) => {
   return inventor.last === "Edison";
 })
 console.log(EdiInventor)

const EdiInventor = inventors.find ( (inventor) => inventor.last === "Edison");
